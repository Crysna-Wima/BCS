...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-5 wizard d-flex flex-column flex-lg-row flex-column-fluid">
          <!--begin::Aside-->
  <div class="login-aside flex-row-fluid d-flex flex-column"
             style="background-image:url({{url('assets/media/bg/cobalogin.jpg')}});background-repeat: no-repeat;background-repeat: round;">
...
{{--             style="background-image: url('{{url('assets/media/svg/shapes/abstract-4.svg')}}'); background-size: cover">--}}
             style="background-image: url('{{url('assets/media/bg/bg-3.jpg')}}'); background-size: cover">
        {{--<div class="login-content flex-row-fluid d-flex flex-column p-10">--}}
        <!--begin::Wrapper-->
            <div class="d-flex flex-column-auto flex-column pt-lg-0 pt-15" >
                <!--begin::Aside header-->
                <a href="#" class="login-logo text-right pt-lg-10 pb-5 pr-15">
                    {{-- <img src="{{ asset('assets/media/logos/PUPUK_INDONESIA.png') }}" class="max-h-90px" alt=""/> --}}
                </a>
            </div>
            ...
            <div class="d-flex flex-row-fluid untuk-kotak-tengh">
                ...
                <div class="login-form">
                    <!--begin::Form-->
                    <form class="form" id="kt_login_singin_form" action="{{ url('login/store') }}" novalidate
                          method="POST">
                    @csrf
                    <!--begin::Title-->
                        <div class="pb-5 pb-lg-5">
                            ...
                            <img src="{{ asset('assets/media/logos/logo-bcs.png') }}"
                                 style=" display: block;margin: 0 auto; width: 400px;" alt=""/>
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('username'))
                                <p class="text-danger"
                                   style="font-size: 11px; padding-top: 0px;">{{$errors->first('username')}}</p>
                            @endif
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            ...
                            @if($errors->has('password'))
                                <p class="text-danger"
                                   style="font-size: 11px; padding-top: 0px;">{{$errors->first('password')}}</p>
                            @endif
                        </div>
                        <!--end::Form group-->
                        <!--begin::Action-->
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" style="background-color:#032987;"
                                    id="kt_login_singin_form_submit_button"
                                    class="btn btn-primary btn-lg btn-block font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">
                                Sign In
                            </button>
                        </div>
