                ...
                <form role="form" class="form" name="formUsers" id="formUsers" enctype="multipart/formdata" method="">
                    <div class="modal-body">
                        <div class="mb-7">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">MK NOPEG</label>
                                <div class="col-lg-9">
                                    <input type="text" id="mk_nopeg" class="form-control" name="mk_nopeg"
                                           placeholder="e.g: 123456789"/>
                                    <span class="form-text text-muted">Please enter your nopeg</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">MK Nama</label>
                                <div class="col-lg-9">
                                    <input type="text" id="mk_nama" class="form-control" name="mk_nama"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control select" id="costcenter" name="costcenter"
                                            data-placeholder="Select a costcenter" style="width: 100%;">
                                        @foreach ($costcenter as $detail)
                                        <option value="{{$detail->id}}">{{ $detail->directorat }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="mb-7">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">MK NOPEG</label>
                                <div class="col-lg-9">
                                    <input type="text" id="mk_nopegEdit" class="form-control" name="mk_nopegEdit"
                                           placeholder="e.g: 123456789"/>
                                    <span class="form-text text-muted">Please enter your nopeg</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">MK Nama</label>
                                <div class="col-lg-9">
                                    <input type="text" id="mk_namaEdit" class="form-control" name="mk_namaEdit"
                                           placeholder="e.g: John Doe"/>
                                    <span class="form-text text-muted">Please enter your name</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Costcenter:</label>
                                <div class="col-lg-9">
                                    <select class="form-control select" id="costcenterEdit" name="costcenterEdit"
                                            data-placeholder="Select a costcenter" style="width: 100%;">
                                        @foreach ($costcenter as $detail)
                                        <option value="{{$detail->id}}">{{ $detail->directorat }}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Photo:</label>
                                <div class="col-lg-9">
                                    <input type="file" id="photoEdit" class="form-control" name="photoEdit">
                                    <span class="form-text text-muted">Please upload your photo</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Status:</label>
                                <div class="col-lg-9">
                                    <select class="form-control select" id="statusEdit" name="statusEdit"
                                            data-placeholder="Select a status" style="width: 100%;">
                                        <option value="1">Active</option>
                                        <option value="2">Inactive</option>
                                    </select>
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function (row) {
                            return '<img src=" assets/img/profile/' + row.photo + '" style="width:50px;height:50px;">';
                        }
                    },
                    {
                        field: 'firstname',
            ...
            $(document).on('click', '.edits', function () {
                $.ajax({
                    ...
                    if (res.success) {
                        ...
                        $(form.elements.mk_nopegEdit).val(res.data.mk_nopeg);
                        $(form.elements.mk_namaEdit).val(res.data.mk_nama);
                        $(form.elements.emailEdit).val(res.data.email);
                        $(form.elements.companyEdit).val(res.data.company);
                        // $(form.elements.costcenterEdit).val(res.data.costcenter);
                        // $('#costcenterEdit').val(res.data.costcenter).change();
                        $('#companyEdit').val(res.data.company).change();
